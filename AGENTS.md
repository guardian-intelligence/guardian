...
`src/chunkies/README.md` is the canonical guide to WUM development setup and helpers: the one-command local stack (`aspect mythra dev up`), its edit loops and harnesses, and the `aspect mythra` operations verbs.
