...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/guardian-intelligence/guardian/src/proto/gen/go/guardian/analytics/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EventServiceName = "guardian.analytics.v1.EventService"
)
...
const (
	...
	EventServicePublishProcedure = "/guardian.analytics.v1.EventService/Publish"
)
...
// NewEventServiceClient constructs a client for the guardian.analytics.v1.EventService service. By
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_guardian_analytics_v1_events_proto.Services().ByName("EventService").Methods()
...
// Publish calls guardian.analytics.v1.EventService.Publish.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/guardian.analytics.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) Publish(context.Context, *connect.Request[v1.PublishRequest]) (*connect.Response[v1.PublishResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("guardian.analytics.v1.EventService.Publish is not implemented"))
}
