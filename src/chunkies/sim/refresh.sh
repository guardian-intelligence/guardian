...
install -m 0644 "$game/park.wasm" "$svc/sim.wasm"
...
install -m 0644 "$game/park.wasm" "$prod/sim.wasm"
...
echo "refreshed: $svc/{client,sim}.wasm, wum/fixture_park.bin, $prod/{client,sim}.wasm, telemetry.gen.ts, and goldens/records.json"
