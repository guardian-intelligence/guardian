...
// today: Postflight Platform. A Solution is the commercial bundle a customer buys.
...
export const SOLUTIONS_META = {
  ...
  description:
    "Postflight Platform is the Guardian compute stack. Services, a web console, CLIs, and SDKs, under one sign.",
} as const;

export const SOLUTIONS: readonly SolutionCard[] = [
  {
    slug: "postflight",
    name: "Postflight Platform",
    kicker: "Compute",
    oneLiner: "Sandboxes, CI runners, and long-running workloads on bare metal you can see.",
    description:
      "Postflight runs code. CI jobs, single-purpose VM workloads, long-running environments. Each workload gets a rehearsable boot image, a short-lived filesystem, and a receipt a founder can audit line-by-line. One tenant never sees another's bytes.",
    products: [
      {
        kind: "service",
    ...
    href: "https://guardianintelligence.org/postflight",
  },
];
