...
const ITEMS: readonly NewsroomItem[] = [
  {
    ...
    body: [
      "SEATTLE, WA — Today, Guardian announces its forecast that direct-to-consumer bare metal hosting becomes a trillion-dollar market by 2030, as coding agents turn software creation from an enterprise discipline into a consumer one. When everyone runs a personal software company, the premium layer of that demand resolves to dedicated hardware.",
  ...
  },
  {
    ...
    title: "Guardian announces private beta of Postflight.",
    ...
    author: { name: "Shovon Hasan", role: "Founder & CEO", avatar: "/people/shovon-hasan.jpg" },
    body: [
      "Seattle, Washington -- Guardian today announced the private beta of Postflight, the world's fastest Agent-Native Cloud. Postflight is a fully open-source cloud platform designed for agent-native software teams, pairing bare-metal performance with persistent developer environments so humans and coding agents can build, test, and deploy from the same durable system state.",
