...
export interface ClientExports {
  ...
  session_tick(): bigint;
  session_seq(): bigint;
  session_stat(kind: number): bigint;
  ...
  session_rtt_ms(): number;
  /** Ticks of disagreement with the authority, Q16. Diagnostics only. */
  session_error_q16(nowMs: bigint): bigint;
