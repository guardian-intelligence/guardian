...
//!
//! The initial tick rate arrives in `welcome.hz`; an epoch advance
//! carrying a new rate sets it and forces the resync whose restore
//! re-seeds this model. The wall-time thresholds above derive from the
//! current rate.
//!
