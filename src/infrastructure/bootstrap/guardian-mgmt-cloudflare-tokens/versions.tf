terraform {
  ...
  # Tokens Read/Write + Account Settings Read; the minter never carries R2 —
  # bucket resources apply through the minted r2_bucket_provisioner token via
  # a provider alias in main.tf. This root-equivalent credential remains
