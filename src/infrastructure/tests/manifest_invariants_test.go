...
func testOpenBaoOpenTofuBootstrap(t *testing.T) {
	...
	assertTextContains(t, mainTF, `resource "vault_policy" "ops_controller"`, "guardian-mgmt-openbao main.tf")
	assertTextContains(t, mainTF, `name = "guardian-openbao-ops-controller"`, "guardian-mgmt-openbao main.tf")
	...
	assertTextContains(t, mainTF, `bound_service_account_names      = ["openbao-ops-controller"]`, "guardian-mgmt-openbao main.tf")
	assertTextContains(t, mainTF, `bound_service_account_namespaces = ["tenant-guardian"]`, "guardian-mgmt-openbao main.tf")
	assertTextContains(t, mainTF, `token_policies                   = [vault_policy.ops_controller.name]`, "guardian-mgmt-openbao main.tf")
	...
	assertTextNotContains(t, mainTF, `path "*"`, "guardian-mgmt-openbao main.tf")
	assertTextNotContains(t, mainTF, `path "sys/*"`, "guardian-mgmt-openbao main.tf")
	assertTextNotContains(t, mainTF, `path "auth/*"`, "guardian-mgmt-openbao main.tf")
