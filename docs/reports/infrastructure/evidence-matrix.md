...
| Public ingress / DNS | `src/infrastructure/bootstrap/cloudflare-dns/`, `src/infrastructure/evidence/http-load.yaml`, `src/infrastructure/inventory/guardian-mgmt.json` | `2026-06-22-public-ingress-dns.md` | same report | same report | remote-IP verifier declared; DNS apply/live execution pending |
