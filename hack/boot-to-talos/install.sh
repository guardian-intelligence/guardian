...
#
# Vendored from cozystack/boot-to-talos hack/install.sh.
# Source: https://github.com/cozystack/boot-to-talos/blob/95af10756c9b90996246273c037832fc3f060abb/hack/install.sh
